...
db.serialize(async () => {
  ...
  //   Dripper_Type STRING);`;
  let sqlDelete1 = `Drop Table Dripper_Pipes;`;
  let sqlDelete2 = `DROP TABLE Pipes;`;
  db.run(sqlDelete1);
  db.run(sqlDelete2);
  ...
  let sqlInsert1 = `INSERT INTO PIPES VALUES ('16009','14.2','3.0'),('16010','14.2','3.5'),('16011','14.2','3.5'),('16012','14.2','4.0'),('20011','17.5','3.5'),('20012','17.5','4.0');`;
  // let sql = `INSERT INTO DRIPPERS_DATA VALUES('0','0','0.7','0','0.7'),('1','0','1','0','1'),('2','0','1.6','0','1.6'),('3','0','2.3','0','2.3'),('4','0','3.5','0','3.5');`;
  let sqlInsert2 = `INSERT INTO Dripper_Pipes Values ('0','0','16009','1.3'),('1','0','16010','1.3'),('2','0','16011','1.3'),('3','0','16012','1.3'),('4','0','20010','0.4'),('5','0','20012','0.4');`;
  db.run(sqlInsert1);
  db.run(sqlInsert2);
  // db.run(sql2);
  // Insert to table
